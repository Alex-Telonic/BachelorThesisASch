...
The typical positions a commercial bank is holding on its balance sheet are: \\

\iffalse
\begin{itemize}
 \item Cash
 \item Fed funds sold and securities purchased under agreements to resell (fedfundsrepoassets)
 \item Securities
  	\begin{itemize}
 	\item Treasury
...
\caption[1]{Stylized balance sheet of us commercial bank \footnote{Every position beside the trading assets are hold "not for trading purposes". Meaning for instance the securities position and loans position are not held for trading.}}
 ...
 Securities: & Deposits:  \\ 
 \begin{tabular}{l} - Treasury \\ - Mortgage-backed Security \\ - Other \end{tabular} & \begin{tabular}{l} - short \\ - other \end{tabular} \\ \hline
