...
\includegraphics[scale=0.4]{graphs/Tables/corr_legend}
...
\includegraphics[scale=0.8]{graphs/Tables/asset_cycle_corr}
...
\includegraphics[scale=0.8]{graphs/Tables/liab_cycle_corr}
\label{fig:corr_liab}
...
\includegraphics[scale=0.8]{graphs/Tables/asset_liab_cycle_corr}
