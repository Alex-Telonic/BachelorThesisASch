...
\item Timeframe: 1976Q1-2013Q4, data per year and quarter for each individual bank
\end{itemize}
...
We are also removing all banks with negative equity and exorbitant high leverage from the dataset as they do not represent the systematic risk level we want to assess.\footnote{Outliers are defined as banks with leverage ratios beyond 100} We want to assess the leverage behaviour of normal operating banks. Banks with negative equity or exorbitant high leverage cannot continue to operate this way and are near bankruptcy. We are looking at the bankruptcy levels of banks in section \ref{sec:AssetLiabs}.
Figure \ref{fig:averageLeverage} and \ref{fig:averageLeverage_noOutlier} below show the mean, median and weighted-average leverage by asset size for each point in time. We can see the clear impact of outlier removal in the data. Especially, in the periods around 1990 and 2008 where bankruptcy levels are high, there are major leverage increases in Figure \ref{fig:averageLeverage}. With outliers removed, we have a clearer indication how leverage among healthy banks look. We will continue to work with the outlier removed leverage data. The Figures also prove that depending of what type of measure is chosen (average, median...), different conclusions can be derived. However, all measures show a falling trend in leverage from year 1976 to 2013.  More description coming...
...
\begin{minipage}{\textwidth}
\centering
\caption[1]{Average leverage by category \footnote{Banks with leverage ratios beyond 100 are considered as outlier and removed.}}
...
\begin{minipage}{\textwidth}
\centering
\caption[1]{Cyclical average leverage by category \footnote{Banks with leverage ratios beyond 100 are considered as outlier and removed.}}
